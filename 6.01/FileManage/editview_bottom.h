#if !defined(AFX_editView_Bottom_H__339F7979_7539_4647_B17E_6769034295BB__INCLUDED_)
#define AFX_editView_Bottom_H__339F7979_7539_4647_B17E_6769034295BB__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// editView_Bottom.h : header file
//
#include "editdoc.h"
#include <afxrich.h>
#include "C_ColorToolTip.h"
/////////////////////////////////////////////////////////////////////////////
// editView_Bottom view

#define		MAX_TEXTSTYLE_NUM	0xfe	// 1 ... 0xff

class editView_Bottom : public CEditView
{
protected:
	editView_Bottom();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(editView_Bottom)
...
//	afx_msg LRESULT OnReplace(WPARAM, LPARAM);
	...
	afx_msg void OnUpdateAddStory(CCmdUI* pCmdUI);
	afx_msg void OnAddStory();
	//}}AFX_MSG
...
#endif // !defined(AFX_editView_Bottom_H__339F7979_7539_4647_B17E_6769034295BB__INCLUDED_)
